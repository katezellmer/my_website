...
function debugCallback(response){
	...
	// prints out the geojson in string form
	$(mydiv).append('<br>GeoJSON data: <br>' + JSON.stringify(response));
};

function debugAjax(){
	// setting variable to get data from the geojson
	var mydata = $.ajax("data/MegaCities.geojson", {
		// indicating the json type
		dataType: "json",
		// telling what shold occur when it succesfully connects
